...
export const setup_protocol_ai4g_cooking_constants = () => ({
  entity: {
...
export const setup_collection_ai4g_constants = () => ({
  entity: {
    // type of entity eg dao/protocol/asset/oracle
    ...
    linkedResources: [
      {
        ...
        mediaType: "application/ld+json",
        serviceEndpoint:
          "ipfs:bafkreicfwdefe4klrgumoqzbgutyyuxytskfi57b2qixryttwjacn2aluu",
        proof: "bafkreicfwdefe4klrgumoqzbgutyyuxytskfi57b2qixryttwjacn2aluu",
        encrypted: "false",
        right: "",
      },
      {
        ...
        mediaType: "application/json",
        serviceEndpoint:
          "ipfs:bafkreigpbuh2flisnmvmmnl2o3qvsvn6klosd73xtspbb22tqdub4iwxyy",
        proof: "bafkreigpbuh2flisnmvmmnl2o3qvsvn6klosd73xtspbb22tqdub4iwxyy",
        encrypted: "false",
        right: "",
      },
      {
