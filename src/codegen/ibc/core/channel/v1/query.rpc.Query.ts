...
export class QueryClientImpl implements Query {
  ...
  upgradeError(request: QueryUpgradeErrorRequest): Promise<QueryUpgradeErrorResponse> {
    ...
    return promise.then(data => QueryUpgradeErrorResponse.decode(new _m0.Reader(data)));
  }
  upgrade(request: QueryUpgradeRequest): Promise<QueryUpgradeResponse> {
    ...
    return promise.then(data => QueryUpgradeResponse.decode(new _m0.Reader(data)));
  }
  channelParams(request: QueryChannelParamsRequest = {}): Promise<QueryChannelParamsResponse> {
    ...
    return promise.then(data => QueryChannelParamsResponse.decode(new _m0.Reader(data)));
  }
}
