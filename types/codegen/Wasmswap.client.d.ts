...
import { Uint128, BalanceResponse, Expiration, TokenSelect, Addr, InfoResponse, Token1ForToken2PriceResponse, Token2ForToken1PriceResponse } from "./Wasmswap.types";
...
export declare class WasmswapQueryClient implements WasmswapReadOnlyInterface {
...
export declare class WasmswapClient extends WasmswapQueryClient implements WasmswapInterface {
