export declare const b64toUint8Array: (b64: string) => Uint8Array<ArrayBuffer>;
export declare const b64toJson: (b64: string) => any;
export declare const Uint8ArrayTob64: (u8: Uint8Array) => string;
export declare const JsonToArray: (json: string) => Uint8Array<ArrayBuffer>;
export declare function Uint8ArrayToJS(data: Uint8Array): string;
export declare const concatArrayBuffers: (...bufs: Uint8Array[]) => Uint8Array<ArrayBuffer>;
 ...
 */
export declare const decodeMbKey: (header: Uint8Array, mbKey: string) => Uint8Array<ArrayBuffer>;
