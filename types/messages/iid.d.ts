 ...
 */
export declare const createVerificationMethod: (did: string, pubkey: Uint8Array, controller: string, type?: KeyTypes) => import("../codegen/ixo/iid/v1beta1/iid").VerificationMethod;
