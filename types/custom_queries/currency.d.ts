...
export declare const findTokenHistoryFromDenom: (denom: string, startDate: string, endDate: string, cacheResult?: boolean) => Promise<TokenAssetHistory | undefined>;
export declare const findTokensHistoryFromDenoms: (denoms: string[], startDate: string, endDate: string, cacheResult?: boolean) => Promise<Array<TokenAssetHistory | undefined>>;
